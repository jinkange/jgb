        ...
        <View style={styles.padWrrap}>
          ...
          <View style={styles.btnWrrap}>
            <View style={styles.startBtnWrrap}>
              <Pressable style={styles.startBtn} onPress={() => navigation.navigate("HOME")}>
                <Text style={styles.btnText}>시작하기</Text>
              </Pressable>
            </View>
            <View style={styles.exitBtnWrrap}>
              <Pressable style={styles.exitBtn} onPress={() => navigation.navigate("HOME")}>
...
const styles = StyleSheet.create({
  ...
  coinText: {fontSize: 13, lineHeight: 21, letterSpacing: 0.25, color: "white", fontFamily: "고령딸기체"},
  btnWrrap: {
    flexDirection: "row",
    justifyContent: "space-around",
    width: "100%",
